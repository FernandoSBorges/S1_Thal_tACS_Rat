...
# Run parameters
#------------------------------------------------------------------------------
cfg.duration = 0.9*1e4 ## Duration of the sim, in ms  
cfg.dt = 0.05
...
cfg.acs_params = {'position': [0.0, 0.0, 0.0],  # um # y = [pia, bone]
              'amp': -20.,  # uA,
              'stimstart': 940.0,  # ms
              'stimend': 950.0,  # ms
              'frequency': 25.0,  # Hz
...
# The parameters of the extracellular point current source
cfg.dc_params = {'position': [0.0, 0.0, 0.0],  # um # y = [pia, bone]
              'amp': -20.,  # uA,
              'stimstart': 2000.0,  # ms
              'stimend': 3000.0,  # ms
              'sigma': 0.57  # decay constant S/m
...
cfg.DC_disk_params = {'position': [210.0, -150.0, 210.0],  # center
                    'radius': 125.0,  # um
                    'amp': 2.0,  # uA,
                    'stimstart': 4000,  # ms
                    'stimend': 8000.0,  # ms
