...
for syntype in syntypes:
    if syntype > 50:  # Exc
        ...
        netParams.synMechParams['S1_II_STP_Det_' + str(syntype)] = {'mod': 'DetGABAAB',
                                         ...
                                         'Dep': dfS6['dep'][syntype], # ± dfS6['depStd'][syntype]  
                                         'Fac': dfS6['fac'][syntype], # ± dfS6['facStd'][syntype]
                                         'tau_d_GABAA': dfS6['decay'][syntype]*cfg.propofolParams['tau_d_GABAA_scale'], # ± dfS6['decayStd'][syntype]
                                         'tau_r_GABAA': 0.2*cfg.propofolParams['tau_r_GABAA_scale'],   #rng.lognormal(0.2, 0.1) in synapses.hoc  
                                         'tau_d_GABAB': 260.9,
                                         'tau_r_GABAB': 3.5,
...
netParams.synMechParams['GABAA'] = {'mod':'MyExp2SynBB', 'tau1': 0.2*cfg.propofolParams['tau_r_GABAA_scale'], 'tau2': 8.3*cfg.propofolParams['tau_d_GABAA_scale'], 'e': -80}
...
netParams.synMechParams['GABAA_Th']            = {'mod': 'MyExp2SynBB',        'tau1': 0.07*cfg.propofolParams['tau_r_GABAA_scale'],   'tau2': 18.2*cfg.propofolParams['tau_d_GABAA_scale'],  'e': -80}
