...
cfg.dt = 0.05
cfg.seeds = {'conn': 4322, 'stim': 1001, 'loc': 4322, 'cell': 4322} 
...
#cfg.preloadCells = True     
#cfg.gatherProcsPre = True    
...
cfg.use_frac['EE'] = 0.25 # steep Ca 2+ dependence for connections between PC-PC and PC-distal targeting cell types (DBC, BTC, MC, BP)
...
#------------------------------------------------------------------------------
cfg.propofolParams = {}
cfg.propofolParams['tau_d_GABAA_scale'] = 1.6  #scaling factor for rate of deactivation of GABAA synapses
cfg.propofolParams['tau_r_GABAA_scale'] = 0.6  #scaling factor for rate of onset of fast desensitization of GABAA synapses
...
#------------------------------------------------------------------------------
cfg.ACSparams = {}
cfg.ACSparams['include'] = False
cfg.ACSparams['amp'] = 0. #stimulation amplitude, uA
cfg.ACSparams['freq'] = 0. #stimulation frequency, Hz
cfg.ACSparams['stimstart'] = 0. #ms
cfg.ACSparams['stimend'] = 0. #ms
cfg.ACSparams['Inh_scale'] = 1.0  #morphology scaling factor for inhibitory neurons
cfg.ACSparams['Exc_scale'] = 1.0  #morphology scaling factor for excitatory neurons
